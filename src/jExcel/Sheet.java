...
public class Sheet extends JTable {
    ...
    private HojaModelo model;
    private Libro book;
    private String name;
    private String brush;
    public Sheet(final Libro book, int numRow, int numColumn, String name) {
        ...
        Celda foo[][];
        foo = new Celda[numRow][numColumn];
        for (int ii = 0; ii < numRow; ii++) {
            for (int jj = 0; jj < numColumn; jj++) {
                foo[ii][jj] = new Celda(this, ii, jj, "", "");
            }
        }
        
        model = new HojaModelo(foo, this);
        setModel(model);
        ...
        ListSelectionListener selectionChanged = new ListSelectionListener() {
            public void valueChanged(ListSelectionEvent e) {
                ...
                book.getContainer().getBarCaption().setText("Fórmula en " + add + " es: ");
    ...
    public void editingStopped(ChangeEvent e) {
        ...
        if (tce != null && tce.getCellEditorValue().toString().equals("")) {
            ...
            super.editingStopped(e); //Para cambiar el cuerpo de los métodos generados, seleccione Herramientas | Plantillas.
        }
    ...
    protected void processKeyEvent(KeyEvent e) {
        ...
        super.processKeyEvent(e); //Para cambiar el cuerpo de los métodos generados, seleccione Herramientas | Plantillas.
    }
    @Override
     ...
     * @return the model
     */
    public HojaModelo getSheetModel() {
        return model;
    }
     ...
     */
    public void setSheetModel(HojaModelo model) {
        this.model = model;
    }
